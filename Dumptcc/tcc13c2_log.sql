...
CREATE TABLE `log` (
  ...
  `data_hora_inicio_acesso` datetime DEFAULT NULL,
  `data_hora_fim_acesso` datetime DEFAULT NULL,
  `cod_status_acesso` char(1) NOT NULL,
  PRIMARY KEY (`cod_log`),
...
-- Dump completed on 2017-10-19  0:36:01
